...
public interface EmployeeTerritoriesRepository extends JpaRepository<EmployeeTerritories,Integer> {
    ...
    @Query("select new kodlama.io.northwind.entities.dtos.EmployeeTerritoryDto(et.employeeTerritoryId,et.employee.firstName,et.employee.lastName,et.territory.territoryDescription)" +
